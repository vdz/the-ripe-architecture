...
**Documentation:**
- [Introduction](/client-architecture/00-introduction)
- [Elements](/client-architecture/01-elements)
- [Global State](/client-architecture/02-global-state)
- [Information Flow](/client-architecture/03-information-flow)
- [App Structure](/client-architecture/04-app-structure)
- [Functional Layers](/client-architecture/05-functional-layers)
- [Best Practices 2026](/client-architecture/07-best-practices-2026)

**Code Examples:**
- [Reducer Example](/examples/reducer)
- [Actions Example](/examples/actions)
- [Listeners Example](/examples/listeners)
- [Component Example](/examples/component)
