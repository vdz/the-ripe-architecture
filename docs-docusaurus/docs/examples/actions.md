...
This example demonstrates the Ripe Method action patterns using Redux Toolkit. Actions are the vocabulary of your application - they describe what can happen.
...
- **Declarative naming** - Actions describe what happened, not how
- **Namespaced** - Use prefixes like `ui/`, `items/` for organization
- **Typed payloads** - Each payload action has a corresponding interface
- **Async patterns** - Use `fetch`, `fetchSuccess`, `fetchFailure` pattern
